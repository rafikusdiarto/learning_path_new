<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-3">
            <a href="<?= base_url('mahasiswa/add') ?>" class="btn btn-sm btn-flat bg-blue"><i class="fa fa-plus"></i> Add</a>
            ...
            <div class="pull-right">
                <button onclick="bulk_delete()" class="btn btn-primary" type="button"><i class="fa fa-trash"></i> Delete</button>
            </div>
        </div>
