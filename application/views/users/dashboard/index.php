...
<div class="card-section">
	<div class="container">
		<div class="card-block bg-white mb30 shadow-sm">
			<div class="row ">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
					<!-- section-title -->
					<div class="section-title mb-0">
						<h2>All about how to become success. We share our knowledge on our beloved members</h2>
	...
	<div class="">
		<div class="solution_cards_box col-12 d-flex align-content-center justify-content-center flex-wrap my-5">
			<?php foreach ($learning_path as $info):?>
				<div class="solution_card col-5">
