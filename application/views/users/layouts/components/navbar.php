<nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
	...
	<form class="d-flex mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
		...
		<div class="mr-4 ml-4 mt-1">
			<a href="<?= base_url('member/dashboard') ?>" type="button">
				Home <i class="fas fa-home fa-sm"></i>
			</a>
		</div>
		<div class="mt-1">
			<a href="<?= base_url('member/learning-path/quiz/history') ?>" type="button">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow">
			<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
				data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<span class="mr-2 d-none d-lg-inline text-gray-600 small">Alisya</span>
